...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/* * Here's a bunch of component-related functions! Enjoy! * */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
if ( ! function_exists( 'cb_core_get_components' ) ) {
	...
	function cb_core_get_components( $type = 'all' ) {
		...
		$required_components = array(
			'transactions' => array(
				'title'       => __( 'Confetti Bits Settings', 'buddyboss' ),
				'description' => __( 'Allow members to send and receive Confetti Bits.', 'buddyboss' ),
				'default'     => true,
			),
		);
