...
//		$this->includes();
	...
	public function late_includes() {
		...
		if ( cb_is_confetti_bits_component() ) {
			...
			require $this->path . 'bp-confetti-bits-transactions/screens/confetti-bits.php';
	...
	public function setup_globals( $args = array() ) {
		...
		$global_tables = array(
			'table_name'    		=> $bp->table_prefix . 'confetti_bits_transactions',
			'table_name_recipients' => $bp->table_prefix . 'confetti_bits_transactions_recipients',
		);
		
		// Metadata tables for messaging component.
		$meta_tables = array(
			'confetti_bits_transaction' => $bp->table_prefix . 'confetti_bits_transactions_meta',
		);
