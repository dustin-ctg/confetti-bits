	...
	class Confetti_Bits {
		...
		private function define_constants() {
			...
			if ( ! defined( 'CONFETTI_BITS_PLUGIN_VERSION' ) ) {
				$this->define( 'CONFETTI_BITS_PLUGIN_VERSION', '2.1.0');				
			}

			if ( ! defined( 'CONFETTI_BITS_PLUGIN_DB_VERSION' ) ) {
				$this->define( 'CONFETTI_BITS_PLUGIN_DB_VERSION', '2.1.0');				
			}
		...
		public function includes() {
			...
			require $this->plugin_dir . 'bp-confetti-bits-core/bp-confetti-bits-core-loader.php';

			require $this->plugin_dir . 'bp-confetti-bits-core/bp-confetti-bits-core-install.php';
			require $this->plugin_dir . 'bp-confetti-bits-core/bp-confetti-bits-core-template.php';
